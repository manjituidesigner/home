...
export default function OwnerOfferDetailsScreen({ route, navigation }) {
  ...
  const onSendRequest = () => {
    Alert.alert('Request', 'Request sent to tenant (static screen for now).');
  };

  const onReject = () => {
    Alert.alert('Offer', 'Rejected (static screen for now).');
  };

  const onHold = () => {
    Alert.alert('Offer', 'Put on hold (static screen for now).');
  };
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.acceptCard}>
          ...
          <View style={styles.acceptBody}>
            ...
            <View style={styles.inputBlock}>
              <Text style={styles.inputLabel}>Propose Meeting Time</Text>
            ...
            <View style={styles.inputBlock}>
              <Text style={styles.inputLabel}>Desired Joining Date</Text>
              <View style={styles.inputWrapIcon}>
            ...
            <TouchableOpacity style={styles.sendBtn} onPress={onSendRequest} activeOpacity={0.9}>
      ...
      <View style={styles.bottomBar}>
        <View style={styles.bottomRow}>
          <TouchableOpacity style={styles.rejectBtn} onPress={onReject} activeOpacity={0.9}>
            <Text style={styles.rejectBtnText}>Reject</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.holdBtn} onPress={onHold} activeOpacity={0.9}>
